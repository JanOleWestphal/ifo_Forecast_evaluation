...
joint_nowcast_df.to_excel(
    excel_writer=os.path.join(table_folder_EDA, "Nowcast_Series_full.xlsx")
)
...
judgment_eval_df_joint.to_excel(os.path.join(table_folder_EDA, "judgemental_derivations_full.xlsx"))
judgment_eval_df_ifoCast.to_excel(os.path.join(table_folder_EDA, "judgemental_derivations_ifoCast.xlsx"))
...
for model_name in naive_nowcasts_dict.keys():
    ...
    # Save
    df_subset.to_excel(os.path.join(table_folder_EDA, f"judgemental_derivations_{model_name}.xlsx"))
...
visualize_summary_statistics(summary_stats_df, graph_folder_EDA_derivations)

# Save to Excel
summary_stats_output_path = os.path.join(table_folder_EDA, "Summary_Statistics.xlsx")
...
def plot_judgemental_derivations_or_net_improvement(
    ...
    Args:
        ...
        graph_folder_EDA: Directory to save plots
...
for model_name, df_eval in all_models_dfs.items():
    ...
    try:
        ...
        derivations_folder = graph_folder_EDA_derivations
        netimp_folder = graph_folder_EDA_net_improvement
        ...
        plot_judgemental_derivations_or_net_improvement(
            df=df_eval,
            kind="derivation",
            graph_folder_EDA=derivations_folder,
    ...
    try:
        plot_judgemental_derivations_or_net_improvement(
            ...
            graph_folder_EDA=netimp_folder,
            header=None,
...
def plot_error_comparison(
    ...
    Args:
        ...
        graph_folder_EDA: Directory to save plot
        filename_prefix: Custom filename prefix
    ...
    suffix = f"_{filename_suffix}" if filename_suffix else ""
    out_path = graph_folder_EDA / f"{prefix}_{benchmark_label}{suffix}.png"
...
for model_name, df_eval in all_models_dfs.items():
    ...
    try:
        ...
        error_baseline_folder = graph_folder_EDA_errors
        ...
        plot_error_comparison(
            ...
            graph_folder_EDA=error_baseline_folder,
...
# --------------------------------------------------------------------------------------------------
print(f" \n ifo Judgemental Forecasting Analysis Module complete! \n",f"Find Result Graphs in {graph_folder_EDA} and \nResult Tables in {table_folder_EDA}\n")
# --------------------------------------------------------------------------------------------------
