...
eval_path = os.path.join(wd, '0_Data', '2_Processed_Data', '2_Evaluation_series')
...
# --------------------------------------------------------------------------------------------------
forecast_path = os.path.join(wd, '0_Data', '0_Forecast_Inputs')

## Filepaths
# ifo
ifo_dec_path = os.path.join(forecast_path, 'ifo_december_forecasts.xlsx')
ifo_jan_path = os.path.join(forecast_path, 'ifo_january_forecasts.xlsx')
...
## Load
# ifo
ifo_dec = pd.read_excel(ifo_dec_path, index_col=0, decimal=',')
ifo_jan = pd.read_excel(ifo_jan_path, index_col=0, decimal=',')
...
file_path_dt_yoy = os.path.join(wd, '0_Data', '3_Naive_Forecaster_Data', '1_YoY_Forecast_Vectors')
